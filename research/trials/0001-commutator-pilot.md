...
The score fails to beat entropy and the target-forward-token-matched replay-repair baseline, or longer replay does not improve ranking beyond uncertainty.
